...
/*	@GetMapping("/create")
	public List<Book> createBooks() {
		...
		books.add(bookService.createBook("L'Étranger", "Albert Camus", "978-3-15-009169-2"));
		books.add(bookService.createBook("Picknick am Wegesrand", "Strugatzki", "978-3-518-37170-1"));
		books.add(bookService.createBook("Neuromancer", "William Gibson", "978-0-441-56959-5"));
		return books;
	}*/
